...
if __name__ == "__main__":
    ...
    #for i in range(0x0020, 0x007F):
        #print str_utils.Q2B(str_utils.B2Q(unichr(i))), str_utils.B2Q(unichr(i))

    # test uniform
    ustring = u'中国 人名ａ高频Ａ'
    print str_utils.is_chinese(ustring)
    #ustring = str_utils.uniform(ustring)
    #ret = str_utils.string2List(ustring)
   # print ret
